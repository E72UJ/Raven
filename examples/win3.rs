...
fn handle_input(mut windows: Query<&mut Window>, keyboard: Res<ButtonInput<KeyCode>>) {
...
fn update_camera_scale(
    ...
    if let (Ok(window), Ok(mut camera_transform)) = (windows.single(), camera_query.single_mut()) {
