...
fn cleanup_scene_a(
    mut commands: Commands,
    query: Query<Entity, With<SceneAEntity>>,
) {
...
fn cleanup_scene_b(
    mut commands: Commands,
    query: Query<Entity, With<SceneBEntity>>,
) {
...
fn switch_scene_system(
    ...
    interaction_query: Query<&Interaction, (With<Button>, With<SwitchSceneButton>, Changed<Interaction>)>,
