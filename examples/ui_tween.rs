...
fn setup(
    ...
    let textbox_container = commands
        .spawn((
            ...
            BackgroundColor(Color::srgba(0.0, 0.0, 0.0, 0.8)), // 半透明黑色基础
        ...
        .with_children(|parent| {
            ...
            parent.spawn((
                ...
                BackgroundColor(Color::srgba(0.2, 0.4, 0.8, 0.7)), // 蓝色渐变起始
            ));
            ...
            parent.spawn((
                ...
                BackgroundColor(Color::srgba(0.6, 0.2, 0.8, 0.3)), // 紫色渐变结束
            ));
            ...
            parent.spawn((
                ...
                TextColor(Color::WHITE), // 改为白色文本以便在深色背景上显示
                Node {
                    position_type: PositionType::Absolute,
                    left: Val::Px(240.0),
                    top: Val::Px(30.0),
