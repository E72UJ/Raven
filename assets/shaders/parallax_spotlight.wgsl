...
@group(2) @binding(4) var background_texture: texture_2d<f32>;
@group(2) @binding(5) var background_sampler: sampler;
...
fn fragment(mesh: VertexOutput) -> @location(0) vec4<f32> {
    ...
    let final_color = mix(background_color, brightened_color, spotlight_mask);
